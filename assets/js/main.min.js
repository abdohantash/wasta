...
$.extend($.easing, {
        ...
        Wolmart.$window = t(window), Wolmart.$body = t(document.body), Wolmart.status = "", Wolmart.isIE = navigator.userAgent.indexOf("Trident") >= 0, Wolmart.isEdge = navigator.userAgent.indexOf("Edge") >= 0, Wolmart.isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), Wolmart.call = function (t, e) {
            ...
            t.fn.countdown && Wolmart.$(e).each((function () {
                var e = t(this),
                    ...
                    o = e.data("labels-short") ? ["عام", "شهر", "اسبوع", "يوم", "ساعة", "دقيقة", "ثانية"] : ["Years", "Months", "Weeks", "Days", "Hours", "Minutes", "Seconds"],
                    s = e.data("labels-short") ? ["عام", "شهر", "اسبوع", "يوم", "ساعة", "دقيقة", "ثانية"] : ["Year", "Month", "Week", "Day", "Hour", "Minute", "Second"];
    ...
    function (t) {
        ...
        e.prototype.init = function (e) {
            ...
            })), a.$sidebar.find(".sidebar-toggle, .sidebar-toggle-btn").add("sidebar" === e ? ".right-sidebar-toggle" : "." + e + "-toggle").on("click", (function (e) {
...
var swiper = new Swiper(".category-sec", {
    speed: 300,
    slidesPerView: 12,
    spaceBetween: 10,
    navigation: {
